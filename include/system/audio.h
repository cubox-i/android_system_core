...
typedef enum {
    ...
    AUDIO_FORMAT_QCELP               = 0x0a000000UL,
    AUDIO_FORMAT_AC3                 = 0x0b000000UL,
    AUDIO_FORMAT_AC3_PLUS            = 0x0c000000UL,
    AUDIO_FORMAT_DTS                 = 0x0d000000UL,
    AUDIO_FORMAT_WMA                 = 0x0e000000UL,
    AUDIO_FORMAT_WMA_PRO             = 0x0f000000UL,
    AUDIO_FORMAT_AAC_ADIF            = 0x10000000UL,
    AUDIO_FORMAT_EVRCB               = 0x11000000UL,
    AUDIO_FORMAT_EVRCWB              = 0x12000000UL,
    AUDIO_FORMAT_EAC3                = 0x13000000UL,
    AUDIO_FORMAT_DTS_LBR             = 0x14000000UL,
    AUDIO_FORMAT_AMR_WB_PLUS         = 0x15000000UL,
    AUDIO_FORMAT_MP2                 = 0x16000000UL,
    AUDIO_FORMAT_EVRCNW              = 0x17000000UL,
    AUDIO_FORMAT_PCM_OFFLOAD         = 0x18000000UL,
#endif
